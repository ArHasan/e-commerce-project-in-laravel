                ...
                <div class="order-area">
                    ...
                    <ul class="total-cost">
                        ...
                        <li>{{$cart->product->product_name}}<span
                                class="pull-right">{{$cart->product->product_price}}</span></li>
                        <?php $count++; ?>
                        @endforeach
...
var stripe = Stripe('pk_test_51GugviJIXUh75oNJWXKNZuaAWGe5mJediubxUuRYRwi70gQ0zgfiJ24S3EnfLDxUSVeUh1OaUeobsOqKi2MuOnJt0099QWVPzf');
