                ...
                <form action="{{route('CartUpdate')}}" method="POST">
                    ...
                    <table class="table-responsive cart-wrap">
                        ...
                        <input type="hidden" value="{{$cart->id}}" name="cart_id[]">
                            ...
                            <tr>
                                <td class="images"><img
                                        src="{{url('img/thumbnail').'/'.$cart->product->product_thumbnail}}" alt="">
                                </td>
                                <td class="product"><a href="single-product.html">{{$cart->product->product_name}}</a>
                                </td>
                                ...
                                @endphp
                                <td class="total">${{$cart->product_quantity * $cart->product->product_price}}</td>
                                <td class="remove" data-id="{{$cart->id}}"><a href="#"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
                        ...
                        <div class="col-xl-3 offset-xl-5 col-lg-4 offset-lg-3 col-md-6">
                            <div class="cart-total text-right">
                                ...
                                <ul>
                                    ...
                                    <li><span class="pull-left">Discount (%{{$discount}})</span>${{$total*($discount/100)}}</li>
                                    <li><span class="pull-left"> Total </span> {{$total*(1-$discount/100)}}</li>
                                </ul>
