            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        <div class="item">
                            <img src="{{url('img/thumbnail')}}/{{$product->product_thumbnail}}"
                                alt="{{$product->procuct_name}}">
                        </div>

                        @foreach(App\ProductGallery::where('product_id',$product->id)->get() as $img)
                        <div class="item">
                            <img src="{{url('img/gallery').'/'.$img->product_gallary}}" alt="">
                        </div>
                        @endforeach
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    <div class="featured-product-img">
                        <img src="{{url('img/thumbnail').'/'.$rel_product->product_thumbnail}}" alt="{{$rel_product->product_name}}">
                    </div>
                    <div class="featured-product-content">
                        <div class="row">
                            <div class="col-7">
                            <h3><a href="{{url('/items').'/'.$rel_product->slug}}">{{$rel_product->product_name}}</a></h3>
